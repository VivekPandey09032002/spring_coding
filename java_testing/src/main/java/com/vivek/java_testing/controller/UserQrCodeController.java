...
public class UserQrCodeController {
    ...
    public ResponseEntity<ResponseCollection<Object>> imageData(@RequestBody RequestUser requestUser) {
        ...
        if (!Objects.equals(user.getKey(), requestUser.getKey())) {
            final var responseBody = ResponseCollection.builder().data(List.of(requestUser))
    ...
    public ResponseEntity<ResponseCollection<Object>> signOutCode(@RequestBody RequestUser requestUser) {
    ...
    public ResponseEntity<ResponseCollection<Object>> registerCode(@RequestBody RequestUser requestUser) {
